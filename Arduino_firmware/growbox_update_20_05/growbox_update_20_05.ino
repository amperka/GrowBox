...
void loop(void) {
  ...
  if (millis() - printTime > PRINT_TIME) {
    ...
    tdsValue = (133.42 * compensateVoltage * compensateVoltage * compensateVoltage -
                255.86 * compensateVoltage * compensateVoltage +
                857.39 * compensateVoltage) * 0.5;
    ...
    Serial.println("{ \"temp\" : " + String(tempSensor.getTempCByIndex(0)) +
                  ", \"acid\" : "  + String(pHValue) +
                  ", \"salin\" : " + String(tdsValue) +
                  ", \"carb\" : "  + String(ccs.geteCO2()) +
                  ", \"level\" : " + String(lvlState) +
                  ", \"lmp\" : "   + String(lampOn) +
                  ", \"lmpMd\" : " + String(lampState) +
                  ", \"fan\" : "   + String(fanOn) +
                  ", \"fanMd\" : " + String(fanTime) +
                  ", \"compr\" : " + String(compressorOn) +
                  ", \"time\" : "  + String(clock.getUnixTime()) +
                  " }");
